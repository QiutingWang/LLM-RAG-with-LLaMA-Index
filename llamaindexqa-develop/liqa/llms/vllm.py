...
class VLLM(CustomLLM):
    ...
    num_output: int = 1024
    model: str = "THUDM/chatglm3-6b"
    port_dict={
          'THUDM/chatglm3-6b':'8000',
          'internlm/internlm-chat-7b-8k':'8001',
          'Qwen/Qwen-14B-Chat':'8002',
          }
    ...
    @property
    def url(self):
        return f"http://0.0.0.0:{self.port_dict[self.model]}/v1/chat/completions"
...
'''
  ...
  os.environ.pop("HTTP_PROXY", None)
  os.environ.pop("HTTPS_PROXY", None)
  our_llm = VLLM(model='Qwen/Qwen-14B-Chat') 
